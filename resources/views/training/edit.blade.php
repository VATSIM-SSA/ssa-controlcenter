        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('training.update.request', $training->id) }}" method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-check-label" for="discord_thread_url">Discord Thread URL</label>
                        <input type="text" class="form-control form-text" id="discord_thread_url" name="discord_thread_url" value="{{ $training->discord_thread_url ? $training->discord_thread_url : '' }}">
                    </div>
                    <div class="mb-3">

...
class UserController extends Controller
{
    ...
    public function show(User $user, StatisticsService $statisticsService)
    {
        ...
        return view('user.show', compact('user', 'roles', 'areas', 'trainings', 'types', 'endorsements', 'areas', 'divisionExams', 'atcActivityHours', 'totalHours', 'recentAtcSessions', 'feedbackReceived'));
    }
